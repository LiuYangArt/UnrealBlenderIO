...
class Const:
    ...
    STATIC_MESH_PROP_COLLISION_TARGET_NAME = "ubio_collision_target_name"
    STATIC_MESH_PROP_COLLISION_ASSET_KEY = "ubio_collision_asset_key"
    STATIC_MESH_PROP_COLLISION_INSTANCE_COUNT = "ubio_collision_instance_count"
    ...
    BP_STATIC_MESH_ROLE_CANONICAL_COLLISION = "CANONICAL_COLLISION"
    BP_STATIC_MESH_ROLE_COMPONENT_WRAPPER = "COMPONENT_WRAPPER"
    BP_STATIC_MESH_ROLE_COMPONENT_OBJECT = "COMPONENT_OBJECT"
    BP_STATIC_MESH_ROLE_COMPONENT_COLLISION = "COMPONENT_COLLISION"
